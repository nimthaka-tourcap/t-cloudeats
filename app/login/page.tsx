...
export default function LoginPage() {
  // Navigation State ('login' or 'pos')
  const [currentView, setCurrentView] = useState<"login" | "pos">("login");
  ...
  // Sound effects or micro-interactions (Visual Feedback)
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === "cashier@t-cloudeats.com" && password === "cashier123") {
        setCurrentView("pos");
        triggerFeedback("Welcome back, Cashier!");
      } else {
    ...
    <div className="min-h-screen bg-[#0B132B] text-[#F8F9FA] font-sans antialiased selection:bg-[#FF6B35] selection:text-white">
      ...
      {currentView === "login" && (
        <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#FF6B35]/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="w-full max-w-md z-10">
            ...
            <div className="text-center mb-8">
              <div className="flex justify-center items-center gap-3 mb-2">
                <div className="relative w-16 h-16 bg-gradient-to-tr from-[#FF6B35] to-orange-600 rounded-2xl flex items-center justify-center shadow-xl shadow-orange-950/40 border border-orange-400/20">
                  <span className="text-3xl font-black text-white italic">T</span>
                  <div className="absolute -top-1 -right-1 bg-sky-400 text-[9px] font-bold text-[#0B132B] px-1.5 py-0.5 rounded-full uppercase tracking-widest">
                    Cloud
                  </div>
                </div>
              ...
              <p className="text-slate-400 text-sm tracking-widest uppercase">Cloud Kitchen POS Terminal</p>
            </div>

            {/* Login Card */}
            <div className="bg-[#1C2541] rounded-3xl p-8 border border-slate-800 shadow-2xl">
              <h2 className="text-xl font-bold mb-6 text-center text-[#F8F9FA]">
                Cashier Sign In
              </h2>
              ...
              <form onSubmit={handleSignIn} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0B132B] border border-slate-700 rounded-xl px-4 py-3 text-[#F8F9FA] focus:outline-none focus:border-[#FF6B35] transition-colors text-sm"
                    placeholder="cashier@t-cloudeats.com"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-[#FF6B35] hover:bg-orange-600 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-orange-500/20 hover:shadow-orange-600/30 transition-all duration-200 flex items-center justify-center gap-2 text-sm cursor-pointer disabled:opacity-50"
                >
                  {isLoading ? (
              ...
              <div className="mt-6 bg-amber-500/5 border border-amber-500/20 rounded-xl p-4">
                <h4 className="text-xs font-bold text-amber-500 uppercase tracking-wider mb-1 flex items-center gap-1.5">
                  <Lock size={12} /> Demo Access Credentials
                </h4>
                <div className="text-xs text-slate-400 space-y-1 font-mono">
                  <p><span className="text-slate-500">Email:</span> cashier@t-cloudeats.com</p>
                  <p><span className="text-slate-500">Pass:</span> cashier123</p>
                  <p className="text-[10px] text-slate-500 mt-2 italic">* Admin PIN for Menu management is <span className="text-amber-500 font-bold">1234</span></p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* --- PART 2: The POS Dashboard Layout --- */}
      {currentView === "pos" && (
          ...
          <aside className="w-[15%] bg-[#1C2541] border-r border-gray-700 flex flex-col justify-between p-4 hidden md:flex shrink-0">
            ...
            <div className="space-y-4 pb-6">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-lg font-bold text-sm text-left text-red-405 hover:bg-red-500/10 transition-all duration-150 cursor-pointer"
              >
                <LogOut size={18} />
                <span>Logout</span>
              </button>
                  ...
                  <div className="bg-[#1C2541] rounded-2xl border border-slate-800 overflow-hidden">
                    ...
                    <div className="divide-y divide-slate-800/80">
                      ...
                      {orderHistory.map((order) => (
                        <div key={order.id} className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                          <div>
                            <div className="flex items-center gap-2">
